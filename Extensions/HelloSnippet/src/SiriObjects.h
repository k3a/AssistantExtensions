...
/** Will be called after the assistant is activated and the first request has been made.
    There is no method called just after the assistant is activated because it would
    be useless as it is normally not possible to issue responses when there is no request.
 \since 1.0.2
 */

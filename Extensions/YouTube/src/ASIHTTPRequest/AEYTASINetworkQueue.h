...
#import "AEYTASIHTTPRequestDelegate.h"
#import "AEYTASIProgressDelegate.h"

@interface AEYTASINetworkQueue : NSOperationQueue <AEYTASIProgressDelegate, AEYTASIHTTPRequestDelegate, NSCopying> {
...
// All AEYTASINetworkQueues are paused when created so that total size can be calculated before the queue starts

...
// This is a helper class used by AEYTASIHTTPRequest to handle deflating (compressing) data in memory and on disk
...
@interface AEYTASIDataCompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}

...
// This is a helper class used by AEYTASIHTTPRequest to handle inflating (decompressing) data in memory and on disk
...
@interface AEYTASIDataDecompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
